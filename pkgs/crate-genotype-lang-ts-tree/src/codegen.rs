...
//     fn register_import(&mut self, import: TsImport) {
...
//     fn inject_descriptor(&mut self, descriptor: GtDescriptor) -> TsRenderResult<String> {
...
//     fn render_module(&self) -> TsRenderResult<String> {
//         self.module
