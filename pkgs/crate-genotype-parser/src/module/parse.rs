        ...
        GtModuleParse(
          module: GtModule(
            ...
            aliases: [
              ...
              GtAlias(
                id: GtDefinitionId(GtModuleId("module"), "AddressId"),
                span: GtSpan(46, 64),
                doc: None,
                attributes: [],
                name: GtIdentifier(GtSpan(46, 55), "AddressId"),
                generics: [],
              ...
              GtAlias(
                id: GtDefinitionId(GtModuleId("module"), "Addresses"),
                span: GtSpan(66, 101),
                doc: None,
                attributes: [],
                name: GtIdentifier(GtSpan(66, 75), "Addresses"),
                generics: [],
                descriptor: Record(GtRecord(
                  span: GtSpan(77, 101),
                  doc: None,
                  attributes: [],
                  key: Reference(GtReference(
                    span: GtSpan(80, 89),
                    doc: None,
                    attributes: [],
                    id: GtReferenceId(GtModuleId("module"), GtSpan(80, 89)),
                    identifier: GtIdentifier(GtSpan(80, 89), "AddressId"),
                    arguments: [],
                  )),
                  descriptor: Reference(GtReference(
                    span: GtSpan(92, 99),
                    doc: None,
                    attributes: [],
                    id: GtReferenceId(GtModuleId("module"), GtSpan(92, 99)),
                    identifier: GtIdentifier(GtSpan(92, 99), "Address"),
                    arguments: [],
                  )),
                )),
              ),
          ...
          resolve: GtModuleResolve(
            ...
            references: [
              ...
              GtIdentifier(GtSpan(92, 99), "Address"),
            ],
            generic_parameters: [],
          ),
        )
