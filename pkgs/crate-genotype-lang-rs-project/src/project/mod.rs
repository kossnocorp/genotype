...
// impl GtlProjectNewOld for RsProject {
//     type Module = RsModule;
...
//     fn lang_config<'a>(&self, config: &'a GtpConfig) -> &'a Self::LangConfig {
//         &config.rs
//     }
...
//     ) -> Result<Self::Module, Box<dyn GtlError>> {
//         todo!()
//     }

//     fn resolve_modules(
//         &self,
//         modules: &mut IndexMap<GtpModulePath, GtlProjectModule<Self::Module>>,
//     ) {
//         // Now when we converted modules, we need to go through all structs and resolve the fields.
...
//         // their extensions.
//         for (_, project_module) in modules.iter() {
//             if let Some(module) = project_module.module() {
...
// pub struct RsProjectOld<'a>(GtlProjectOld<'a, RsModule, RsConfig>);

// impl<'a> GtlProjectImplOld<'a> for RsProjectOld<'a> {
//     type ProjectModule = RsProjectModule;

//     fn new(
//         modules: Vec<GtlProjectModule<GtlProjectProjectModuleTarget<'a, Self>>>,
//         config: GtlProjectPkgConfig<'a, Self>,
//     ) -> Self {
//         RsProjectOld(GtlProjectOld { modules, config })
//     }

//     fn resolve(&mut self) {}

//     fn dist(&self) -> Result<GtlProjectDistOld> {
//         todo!();
//         // let mut files = vec![];
...
//     fn pkg_config(project: &'a GtProject) -> GtlProjectPkgConfig<'a, Self> {
//         project.pkg_config_rs()
//     }

//     fn as_project(&'a self) -> &'a GtlProjectTarget<'a, Self> {
//         &self.0
//     }
// }
