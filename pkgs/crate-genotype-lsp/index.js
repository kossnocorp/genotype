...
module.exports.getBinPath = function getBinPath(contextPath = __dirname) {
  ...
  const binPath = join(contextPath, "node_modules", "@genotype-lsp", variation, "bin", binName);

  if (!existsSync(binPath)) throw new Error(`Genotype LSP binary not found at: ${binPath}`);
