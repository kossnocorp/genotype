...
A record key can be `string`, a numeric type, or a reference to one of these primitives. You can also use references to branded primitives:
...
<Aside type="caution">
  Boolean and composite type references aren't supported as record keys
  ([not](https://github.com/kossnocorp/genotype/issues/159)
  [yet](https://github.com/kossnocorp/genotype/issues/160)).
</Aside>
