...
You can also download the binary from [the latest GitHub release page](https://github.com/kossnocorp/genotype/releases/latest) or build it from source via `cargo install genotype_cli`.
