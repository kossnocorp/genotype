// Do not edit manually! Code generated from ../../../crate-genotype-core/types/diagnostic.type

import { z } from "zod";

export const GtDiagnosticKind = z.union([
  z.literal("error"),
  z.literal("warning"),
  z.literal("success"),
  z.literal("info"),
...
export type GtDiagnosticContentMessageBodySingle = z.infer<
  typeof GtDiagnosticContentMessageBodySingle
>;

export const GtDiagnosticContentMessageBodyMulti = z.array(z.string());

export type GtDiagnosticContentMessageBodyMulti = z.infer<
  typeof GtDiagnosticContentMessageBodyMulti
>;

export const GtDiagnosticContentMessageBody = z.union([
  GtDiagnosticContentMessageBodySingle,
  GtDiagnosticContentMessageBodyMulti,
]);
